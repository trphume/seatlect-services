...
.PHONY: gen_openapi gen_openapi_user  gen_openapi_business gen_openapi_admin gen_openapi_request gen_openapi_reservation gen_openapi_placement gen_openapi_employee gen_openapi_order clean_openapi
...
gen_openapi: gen_openapi_user gen_openapi_business gen_openapi_admin gen_openapi_request gen_openapi_reservation gen_openapi_placement gen_openapi_employee gen_openapi_order
...
gen_openapi_order:
	@oapi-codegen -o internal/gen_openapi/order_api/order_api.gen.go -package order_api -generate "types,server,spec" api/openapi/order.yml
